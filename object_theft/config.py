...
OBJECT_THEFT_CONFIDENCE_THRESHOLD = float(
    os.getenv("OBJECT_THEFT_CONFIDENCE_THRESHOLD", "0.35")
)
OBJECT_THEFT_IOU_THRESHOLD = float(
    os.getenv("OBJECT_THEFT_IOU_THRESHOLD", "0.45")
)
...
OBJECT_THEFT_DISAPPEARANCE_GRACE_FRAMES = max(
    1, int(os.getenv("OBJECT_THEFT_DISAPPEARANCE_GRACE_FRAMES", "15"))
)
